...
Author: Youran
Changes:
- 2025-02-11: Add slow_motion_factor for testing; add action 2 for no force.
"""
...
class MyCartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    """
    ## Description
    ...
    * v0: Initial versions release.
    ...
    def __init__(
        self, sutton_barto_reward: bool = False, render_mode: Optional[str] = None, slow_motion_factor: float = 1.0
    ):
        ...
        self.force_mag = 10.0
        self.tau = 0.02 * slow_motion_factor  # seconds between state updates
        self.kinematics_integrator = "euler"

        # Angle at which to fail the episode
        # self.theta_threshold_radians = 12 * 2 * math.pi / 360
        # self.x_threshold = 2.4
        self.theta_threshold_radians = 12 * 2 * math.pi / 360 / slow_motion_factor
        self.x_threshold = 2.4
